...
public class DaftarHewanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (hewans.get(0) instanceof Merpati) {
            judul = getString(R.string.merpati_list_title);
        }else if (hewans.get(0) instanceof Turtle) {
            judul = getString(R.string.kura_list_title);
        }
